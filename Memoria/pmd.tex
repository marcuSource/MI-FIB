...
\textcolor{royalyellow}{\LARGE{Calidad}} \newline
...
\textcolor{royalyellow}{\LARGE{Confianza}} \newline
...
\textcolor{royalyellow}{\LARGE{Innovación}} \newline
...
\textcolor{royalyellow}{\LARGE{Personalización}} \newline
...
\begin{table}[h]
    ...
    \begin{tabular}{!{\color{black}\vrule} >{\centering\arraybackslash\columncolor{bknwhite}\fontfamily{qag}\selectfont}p{3cm} !{\color{black}\vrule} >{\centering\arraybackslash}p{4cm} !{\color{black}\vrule} >{\centering\arraybackslash}p{4cm} !{\color{black}\vrule} >{\centering\arraybackslash}p{4cm} !{\color{black}\vrule}}
...
\begin{table}[h]
    ...
    \begin{tabular}{!{\color{black}\vrule} >{\raggedright\arraybackslash\columncolor{bknwhite}\fontfamily{qag}\selectfont}p{4.5cm} !{\color{black}\vrule} >{\centering\arraybackslash}p{2cm} !{\color{black}\vrule} >{\centering\arraybackslash}p{1.8cm} !{\color{black}\vrule} >{\centering\arraybackslash}p{1.8cm} !{\color{black}\vrule} >{\centering\arraybackslash}p{2cm} !{\color{black}\vrule}}
    \noalign{\hrule height 1pt} % Top rule
    \rowcolor{royalblue}{\fontfamily{qag}\selectfont\color{white} Criterios} & {\fontfamily{qag}\selectfont\color{white} Calificación} & {\fontfamily{qag}\selectfont\color{white} \# Preguntas} & {\fontfamily{qag}\selectfont\color{white} \# Respuesta} & {\fontfamily{qag}\selectfont\color{white} Calificación} \\
    \noalign{\hrule} % Mid rule
...
% Note: Remember to include in your preamble:
% \usepackage{xcolor,colortbl}
% \definecolor{lightroyalyellow}{RGB}{173,216,230}
